...
class AverageBrightnessTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.batch = BatchData(images=torch.zeros((1, 3, 100, 100)),
                               labels=[],
                               split='val')

    def test_black_image(self):
        self.feature_extractor.execute(self.batch)
        print(self.feature_extractor._brightness)
    ...
    def _process(self):
        for split in ['train', 'val']:
            ...
            create_bar_plot_old(self.ax, list(values), bins,
