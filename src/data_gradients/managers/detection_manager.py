...
class DetectionAnalysisManager(AnalysisManagerAbstract):
    ...
    def __init__(
        ...
        *,
        ...
        val_iterator: Optional[Iterable[SupportedDataType]] = None,
        ...
        if not isinstance(train_iterator, DetectionDatasetAdapter):
            train_iterator = DetectionDatasetAdapter(
        ...
        if not isinstance(val_iterator, DetectionDatasetAdapter):
            val_iterator = DetectionDatasetAdapter(
        ...
        train_sample_iterable = DetectionSampleIterable(dataset=train_iterator, class_names=train_iterator.class_names, split="train")
        val_sample_iterable = DetectionSampleIterable(dataset=val_iterator, class_names=val_iterator.class_names, split="val")
