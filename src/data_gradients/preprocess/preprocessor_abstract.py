...
class PreprocessorAbstract(ABC):
    def __init__(self, n_classes, images_extractor, labels_extractor, n_image_channels):
        self.number_of_classes: int = n_classes
        self._n_image_channels: int = n_image_channels
