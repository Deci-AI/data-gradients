...
class DataConfig(ABC):
    ...
    def get_images_extractor(self, question: Optional[ClosedQuestion] = None, hint: str = "") -> Callable[[SupportedDataType], torch.Tensor]:
        if self.images_extractor is None:
    ...
    def get_labels_extractor(self, question: Optional[ClosedQuestion] = None, hint: str = "") -> Callable[[SupportedDataType], torch.Tensor]:
        if self.labels_extractor is None:
