...
class ClosedQuestion(Question):
    ...
    Example:
        >>> option_question = ClosedQuestion("Choose a color:", {"R": "Red", "G": "Green", "B": "Blue"})
...
def ask_option_via_stdin(question: ClosedQuestion, hint: str) -> Any:
    """
    Capture responses for option-based questions from the command line.

    :param question:    An instance of ClosedQuestion.
    :param hint:        A hint or additional instruction for the question.
...
def ask_option_via_jupyter(question: ClosedQuestion, hint: str) -> str:
    """
...
if __name__ == "__main__":
    # Example usage:
    option_q = ClosedQuestion("Choose an option:", {"A": "Option A", "B": "Option B"})
