...
class BatchProcessor(ABC):
    ...
    def __init__(self, dataset_output_mapper: DatasetOutputMapper, batch_formatter: BatchFormatter, batch_preprocessor: BatchPreprocessor):
        """
        :param dataset_output_mapper:     Object responsible for extracting images and labels from the raw batch.
    ...
    def process(self, unprocessed_batch: Union[Tuple, List, Mapping], split: str) -> Iterable[ImageSample]:
        images, labels = self.dataset_output_mapper.extract(unprocessed_batch)
